  ...
  const validateUser = async (auctionId, userId) => {
    try {
      ...
      if (res?.status === "registered") {
        // Check balance against registration fee
          ...
          {isValidating ? (
            ...
            <div className="flex flex-col items-center">
              ...
              {validationResult?.team !== null ? (
                <div className="w-full bg-gray-100 rounded-lg p-4 text-sm">
                  ...
                  <p className="mt-2">
                    <strong>Current Balance:</strong> {validationResult.balance} Cr
                  </p>
                </div>
              ) : (
                <div className="w-full bg-gray-100 rounded-lg p-4 text-sm">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-center text-gray-600 mb-4">
                Your current balance is {validationResult.balance} Cr, 
                but the registration fee is {auction.registrationFee} Cr. 
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white">
        {validationResult?.status === "success" ? (
          ...
          <div className="px-4 py-3 bg-red-500 text-white rounded-lg w-full font-medium text-[16px] text-center">
            You cannot participate in this auction
          </div>
        ) : (
          <button
            disabled
