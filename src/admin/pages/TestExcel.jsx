...
const PlayersRegistration = () => {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const response = await fetch('https://server.rishabh17704.workers.dev/api/upload', {
        method: 'POST',
        body: formData,
      });
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="bg-white shadow-md rounded-lg p-6">
        <h1 className="text-2xl font-bold mb-6 flex items-center">
          <Upload className="mr-3 text-blue-600" /> Excel to Player Registration
        </h1>
        ...
        {registrationStatus && (
          <div className="mt-6">
            <h2 className="text-xl font-semibold mb-4">Registration Results</h2>
